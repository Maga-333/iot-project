    ...
    const diseaseData = {
        cold: {
            ...
            devices: [
                ...
                { name: 'Cold Relief App', price: 'Free', link: 'https://play.google.com/store/apps/details?id=com.coldreliefapp' }
            ]
        },
        fever: {
            name: 'Fever',
            ...
            devices: [
                ...
                { name: 'Fever Monitor App', price: 'Free', link: 'https://play.google.com/store/apps/details?id=com.fevermonitor' }
            ]
        },
        headaches: {
            name: 'Headaches',
            ...
            devices: [
                ...
                { name: 'Migraine Relief App', price: 'Free', link: 'https://play.google.com/store/apps/details?id=com.migrainereliefapp' }
            ]
        },
        allergies: {
            name: 'Allergies',
            ...
            devices: [
                ...
                { name: 'Allergy Relief App', price: 'Free', link: 'https://play.google.com/store/apps/details?id=com.allergyreliefapp' }
            ]
        },
        diabetes: {
            name: 'Diabetes',
            ...
            devices: [
                ...
                { name: 'Diabetes Tracker App', price: 'Free', link: 'https://play.google.com/store/apps/details?id=com.diabetestracker' }
            ]
        },
        asthma: {
            name: 'Asthma',
            ...
            devices: [
                ...
                { name: 'Asthma Management App', price: 'Free', link: 'https://play.google.com/store/apps/details?id=com.asthmaapp' }
            ]
        },
        hiv: {
            name: 'HIV',
            ...
            devices: [
                ...
                { name: 'HIV Tracker App', price: 'Free', link: 'https://play.google.com/store/apps/details?id=com.hivtracker' }
            ]
        },
        hypertension: {
            name: 'Hypertension',
            ...
            devices: [
                ...
                { name: 'BP Tracker App', price: 'Free', link: 'https://play.google.com/store/apps/details?id=com.bpmonitor' }
            ]
        }
    };
